...
export const ALL_FIELDS = [
  { key: "tipoDoc", label: "Tipo Doc.", w: 100, type: "text" },
  { key: "cufe", label: "CUFE/CUDE", w: 120, type: "text" },
  { key: "folio", label: "Folio", w: 90, type: "text" },
  { key: "prefijo", label: "Prefijo", w: 70, type: "text" },
  { key: "divisa", label: "Divisa", w: 60, type: "text" },
  { key: "formaPago", label: "F. Pago", w: 65, type: "text" },
  { key: "medioPago", label: "M. Pago", w: 65, type: "text" },
  { key: "fechaEmision", label: "F. Emisión", w: 95, type: "text" },
  { key: "fechaRecepcion", label: "F. Recepción", w: 95, type: "text" },
  { key: "nitEmisor", label: "NIT Emisor", w: 95, type: "text" },
  { key: "nombreEmisor", label: "Nombre Emisor", w: 180, type: "text" },
  { key: "nitReceptor", label: "NIT Receptor", w: 95, type: "text" },
  { key: "nombreReceptor", label: "Nombre Receptor", w: 140, type: "text" },
  { key: "iva", label: "IVA", w: 90, numeric: true, type: "text" },
  { key: "total", label: "Total", w: 100, numeric: true, type: "text" },
